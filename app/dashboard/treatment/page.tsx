...
const treatmentPlan = {
  ...
  patientId: "P-7890",
  diagnosis: "Basal Cell Condition (Stage I)",
  dermatologist: "Dr. Priya Sharma",
  ...
  followUps: [
    { date: new Date(2023, 3, 15), type: "Dermatologist Consultation", completed: true },
    { date: new Date(2023, 4, 15), type: "Dermatology Check-up", completed: true },
    { date: new Date(2023, 5, 15), type: "Dermatologist Consultation", completed: true },
    { date: new Date(2023, 6, 15), type: "Dermatology Check-up", completed: false },
    { date: new Date(2023, 7, 15), type: "Dermatologist Consultation", completed: false },
  ],
  progressData: [
...
export default function TreatmentPage() {
  ...
  const handleDownloadPDF = () => {
    ...
    doc.text(`Dermatologist: ${treatmentPlan.dermatologist}`, 20, 75)
    ...
    doc.setFontSize(14)
    doc.text("Dermatologist Notes", 20, yPos)
    doc.setFontSize(10)
    doc.text(treatmentPlan.notes, 20, yPos + 10)

    // Add footer
    doc.setFontSize(8)
    doc.text("This treatment plan was generated by DermaAI under the supervision of your dermatologist.", 105, 280, {
      align: "center",
    })
            ...
            <div className="flex flex-col justify-between">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <span>{treatmentPlan.dermatologist}</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="grid gap-6 md:grid-cols-3">
                ...
                <div className="md:col-span-2">
                  <div className="rounded-lg border p-4">
                    <h3 className="font-medium mb-2">Dermatologist Notes</h3>
            ...
            <CardContent>
              <div className="flex flex-col items-center justify-center py-8 text-center">
                ...
                <p className="text-sm text-muted-foreground mt-2 max-w-md">
                  ...
                  or concerns, please contact your dermatologist.
                </p>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="rounded-lg border p-4">
              ...
              <ul className="text-sm text-muted-foreground space-y-1">
                ...
                <li className="flex items-center gap-2">
                  <CheckCircle className="h-4 w-4 text-green-500" />
                  Dermatologist notes and instructions
                </li>
              </ul>
            </div>
          </div>
